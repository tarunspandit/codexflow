...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "One command gives ChatGPT shared local environments, managed worktrees, guarded Git workflows, persistent terminals, native change review, and scheduled local-project runs through a secure MCP bridge.",
    ...
    openGraph: {
      ...
      description:
        "Parallel and scheduled local coding from ChatGPT with shared project environments, managed worktrees, persistent terminals, native change review, and private routes.",
      url: "/",
