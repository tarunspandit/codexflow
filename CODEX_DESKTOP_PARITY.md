...
| Native management app | Available on macOS | Broker lifecycle, projects, environments, worktrees, changes, chats, hosts, Computer Use, Browser, connection, and policy are first-class SwiftUI views. |
...
1. Richer native plan/task progress and agent orchestration inside the coding workspace.
2. Equivalent native clients beyond macOS.
