...
| UI-001 | The native IA is Now / Projects / Environments / Worktrees / Changes / Chats / Hosts / Computer / Browser / Connection / Policy, composed from first principles for desktop. | Required | Verified | Native navigation shell | All destinations build and fixture/API states are covered by native smoke checks; the navigation remains scrollable at minimum height. |
